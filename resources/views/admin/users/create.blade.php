...
<div class="max-w-3xl mx-auto">
    <div class="mb-6">
        <h1 class="text-2xl font-bold text-slate-800">เพิ่มผู้ใช้งานใหม่</h1>
        <p class="text-slate-500 text-sm">สร้างบัญชีผู้ใช้งานและกำหนดสิทธิ์</p>
    </div>
        ...
        <form action="{{ route('admin.users.store') }}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                ...
                <div class="col-span-2 md:col-span-1">
                    ...
                    <input type="text" name="name" value="{{ old('name') }}" class="w-full bg-slate-50 border border-slate-300 rounded-lg p-2.5 focus:ring-primary-500 focus:border-primary-500 outline-none" required>
                ...
                <div class="col-span-2 md:col-span-1">
                    ...
                    <input type="email" name="email" value="{{ old('email') }}" class="w-full bg-slate-50 border border-slate-300 rounded-lg p-2.5 focus:ring-primary-500 focus:border-primary-500 outline-none" required>
                ...
                <!-- Password -->
                <div class="col-span-2 md:col-span-1">
                    <label class="block mb-2 text-sm font-medium text-slate-700">รหัสผ่าน <span class="text-red-500">*</span></label>
                    <input type="password" name="password" class="w-full bg-slate-50 border border-slate-300 rounded-lg p-2.5 focus:ring-primary-500 focus:border-primary-500 outline-none" required>
                    @error('password') <p class="mt-1 text-sm text-red-600">{{ $message }}</p> @enderror
                </div>

                <!-- Confirm Password -->
                <div class="col-span-2 md:col-span-1">
                    <label class="block mb-2 text-sm font-medium text-slate-700">ยืนยันรหัสผ่าน <span class="text-red-500">*</span></label>
                    <input type="password" name="password_confirmation" class="w-full bg-slate-50 border border-slate-300 rounded-lg p-2.5 focus:ring-primary-500 focus:border-primary-500 outline-none" required>
                </div>
            </div>
